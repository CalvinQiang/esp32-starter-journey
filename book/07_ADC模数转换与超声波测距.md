...
## 7.5 实战第 1 步：ADC 单次采样与电压测量（Hello ADC）

我们先从最基础的模数转换开始，学习如何用 ESP-IDF 最新官方 **ADC Oneshot 驱动**，测量 `GPIO36` 的原始数字与转换电压！
...
## 7.7 实战第 3 步：HC-SR04 超声波微秒级声波测距
...
## 7.8 实战第 4 步：高阶质变 —— 用 NTC 温度实时补偿超声波声速
...
## 7.9 实战第 5 步：终极综合大工程 —— 双任务温声融合环境监测雷达
