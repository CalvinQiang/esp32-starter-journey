...
- [x] **第 07 关：ESP32 模拟量采集(ADC 测温)与超声波测距(HC-SR04)** 📖 [【阅读深度教程】](./book/07_ADC模数转换与超声波测距.md)
- [x] **第 08 关：I2C 通信总线探秘(I2C Scanner)与 DHT11 单总线时序解析** 📖 [【阅读深度教程】](./book/08_I2C总线探秘与DHT11温湿度解析.md)
...
- [x] **第 11 关：ESP32 搭载 LVGL v9 现代图形界面与 CST816S 电容触摸实战** 📖 [【阅读深度教程】](./book/11_LVGL图形框架与电容触摸实战.md)

### 阶段五：无线互联与智能物联网（打通手机与云端）
- [x] **第 12 关：ESP32 Wi-Fi 联网、SNTP 网络授时时钟与 HTTP/cJSON 天气获取** 📖 [【阅读深度教程】](./book/12_WiFi连接管理与HTTP天气时钟.md)
- [x] **第 13 关：ESP32 MQTT 物联网双向通信与云平台联动实战(手机远程控制)** 📖 [【阅读深度教程】](./book/13_MQTT协议接入与阿里云IoT实战.md)
- [x] **第 14 关：ESP32 BLE 低功耗蓝牙实战与微信小程序双向互联** 📖 [【阅读深度教程】](./book/14_BLE低功耗蓝牙与微信小程序互联.md)

### 阶段六：架构、扩展与毕业设计实战
- [x] **第 15 关：ESP32 挂载 MicroSD/TF 卡(4-bit SDIO)与 FATFS 电子相册** 📖 [【阅读深度教程】](./book/15_TF卡文件系统与电子相册.md)
- [x] **第 16 关：ESP32 低功耗电源管理与 Deep-sleep 休眠唤醒(电池省电技术)** 📖 [【阅读深度教程】](./book/16_低功耗电源管理与DeepSleep.md)
- [x] **第 17 关：嵌入式软件工程化 —— 驱动/业务分层、事件总线与组件化模块设计** 📖 [【阅读深度教程】](./book/17_嵌入式软件工程与模块化分层架构.md)
- [x] **第 18 关：ESP32 终极综合大实战 —— 桌面多功能智能气象站与物联网超级中控台 (毕业设计)** 📖 [【阅读深度教程】](./book/18_桌面智能气象站与物联网超级中控.md)
...
* 📘 [**第 18 章：ESP32 终极综合大实战 —— 桌面多功能智能气象站与物联网超级中控台 (毕业设计)**](./book/18_桌面智能气象站与物联网超级中控.md)
...
├── 11_lvgl_touch/          # Level 11: 实验1(LVGL Hello) / 实验2(触摸按钮) / 方案3(智能家居中控面板)
...
./switch_code.sh 18 1          # 切换到第 18 关实验 1 (多任务多中枢系统看板)
./switch_code.sh 18 2          # 切换到第 18 关实验 2 (终极桌面智能中控台总成)

# 3. 一键切换并直接编译/烧录运行
./switch_code.sh 18 2 --flash  # 切换到第 18 关毕业大作并自动烧录启动监视器
```
